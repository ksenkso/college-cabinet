...
@Component({
  ...
  styleUrls: ['./portfolio-creative.component.css']
})
export class PortfolioCreativeComponent implements OnInit {
    ...
    this.route
      ...
      .subscribe(id => {
        ...
        this.portfolioService
          .getSection(this.userId, PortfolioService.TYPE_CREATIVE)
          .then(items => {
  ...
  save() {
    ...
    this.toCreate.forEach(id => body.create.push({
      ...
      record_type: PortfolioService.TYPE_CREATIVE,
      user_id: this.userId
    }));
