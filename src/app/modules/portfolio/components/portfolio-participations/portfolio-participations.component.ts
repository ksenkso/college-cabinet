...
@Component({
  selector: 'app-portfolio-participations',
  templateUrl: './portfolio-participations.component.html',
  styleUrls: ['./portfolio-participations.component.css']
})
export class PortfolioParticipationsComponent implements OnInit {
    ...
    this.route
      ...
      .subscribe(id => {
        ...
        this.portfolioService
          .getSection(this.userId, PortfolioService.TYPE_CONF)
          .then(items => {
  ...
  save() {
    ...
    this.toCreate.forEach(id => body.create.push({
      ...
      record_type: PortfolioService.TYPE_CONF,
      user_id: this.userId
    }));
